...
import Serlis from "../components/Ser/Serlis";
import featureImg from "../assets/images/feature-img.png";
import featureIcon from "../assets/images/video-icon.png";
import avatarIcon from "../assets/images/avatar-icon.png";
import Doclis from "../components/Doctors/Doclis";
            ...
            {/*Content */}
                <div>
                    <div className='lg:w-[570px]'>
                        ...
                        Ut ac elementum tellus. Mauris gravida imperdiet consequat.
                        Quisque tempor nibh ipsum, eget sodales nulla porttitor
                        sit amet.
                        </p>
                    ...
                    <div className='py-[30px] px-5'>
                        ...
                        <div className="mt-[30px]">
                            ...
                            <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
                                World class care for everyone. Our health system offers unmatched, expert health care. From the
                                lab to the clinic. 
                            </p>
            ...
            <div className="container">
                <div className="flex items-center justify-between flex-col lg:flex-row">
                    ...
                    <div className="xl:w-[670px]">
                        ...
                        <Link to="https://www.google.com"><buttion className="btn">Learn More</buttion></Link>
                    </div>
